<?php $__env->startSection('content'); ?>
  <pagina tamanho="12">
    ...
    <painel titulo="Lista de Artigos">
      ...
      v-bind:itens="<?php echo e($listaArtigos); ?>"
  ...
  <modal nome="adicionar" titulo="Adicionar">
    <formulario id="formAdicionar" css="" action="<?php echo e(route('artigos.store')); ?>" method="post" enctype="" token="<?php echo e(csrf_token()); ?>">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" id="conteudo" name="conteudo" ><?php echo e(old('conteudo')); ?></textarea>
      </div>

      <div class="form-group">
        <label for="data">Data</label>
        <input type="datetime-local" class="form-control" id="data" name="data" value="<?php echo e(old('data')); ?>">
      </div>
